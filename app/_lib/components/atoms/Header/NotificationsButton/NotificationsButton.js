...
export default function NotificationsButton({dropdownOpen, setDropdownOpen}) {
    return (
        <button 
            ...
            <span
                className="absolute right-0 top-0.5 z-1 h-2 w-2 rounded-full bg-orange-400">
                <span
                    className="absolute -z-1 inline-flex h-full w-full animate-ping rounded-full bg-orange-400 opacity-75"></span>
            </span>
